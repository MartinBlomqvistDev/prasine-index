# LKAB — Greenwashing Assessment

**Verdict: MISLEADING** | Score: 52/100 | Confidence: 62%
*Published: 2026-05-05 | Prasine Index | Trace ID: a8e2abd1-1266-47fe-85ad-a2739ca42625*

---

## The Claim

> "The road towards carbon-free production by 2045 goes via three strategic innovation areas."

*Source: Corporate website sustainability page, https://www.lkab.com/en/sustainability/, date unknown*

---

## Evidence

**[1] E-PRTR regulated emissions data, 2024**
E-PRTR records show LKAB's regulated industrial emissions (CO₂, GHGs, NOₓ, NMVOC combined):
- 2024: 993,354 tonnes
- 2020–2024 trend: 1,326,063 t → 993,354 t (−25.1% reduction over 4 years)
- 2007–2024 long-term trend: 834,047 t → 993,354 t (+19% increase over 17 years)
...
1. **Current absolute emissions (993 kt/year) remain substantial.** A "carbon-free" outcome implies near-zero residual emissions (<50 kt, or 95%+ reduction from 2024 baseline). At the 2020–2024 rate of reduction, this trajectory would require dramatic acceleration between 2030 and 2045.

2. **Long-term trend is unfavorable.** Emissions rose 19% from 2007 to 2024, indicating that structural conditions have historically driven growth. Recent improvements (2020–2024) may reflect temporary operational adjustments or pandemic-related production changes rather than systemic transition.

3. **No interim targets confirm acceleration is planned.** The claim provides no evidence that capex, technology deployment, or energy-source switching has been budgeted to sustain the 2020–2024 rate of reduction, let alone accelerate it.

The recent downward trend prevents outright falsification of the claim, but does not establish credibility for a 2045 net-zero endpoint.
...
### Historical Pattern (55/100)
LKAB's prior claim history (6 prior assessments, average score 56.7, trend DETERIORATING) indicates a pattern of sustainability claims with limited substantiation. This current claim is consistent with that pattern: bold aspiration without measurable interim checkpoints or independent validation. This is not a repeat claim, but reflects institutional weakness in target-setting rigor.

### Data Gaps & Verification Challenges
- **EU ETS absence is significant.** LKAB has no registered installations in the EU ETS. For a company with ~1 Mt/year of regulated emissions, this is unexpected. Either LKAB operates below ETS thresholds (unlikely for its sector and scale), or emissions are classified under E-PRTR only. This prevents cross-verification against the most rigorous EU emissions registry (ETS verification is independent and third-party audited). Confidence in the E-PRTR baseline is therefore moderate (0.55).
- **CSRD status unclear.** If LKAB is CSRD-obligated, the absence of audited Scope 1/2/3 baselines in the claim represents a material disclosure gap. If LKAB is exempt, the claim lacks any independent audit trail.
- **No SBTi, CA100+, or other independent validator retrieved.** This is a substantiation failure under best practice standards.
...
1. **EU ETS registration data:** No installation IDs found for LKAB. This prevents independent verification of emissions baselines against the most rigorous EU registry. E-PRTR remains the primary source, with moderate confidence (0.55) due to potential scope ambiguity.

2. **Science-based target validation (SBTi):** No validation found. This is a material gap for a net-zero claim.

3. **Third-party transition plan review:** No audited transition plan, capex allocation, or technology roadmap disclosed in public sources. This prevents verification that the 2045 target is credible.

4. **CSRD compliance status:** Unclear whether LKAB is CSRD-obligated. If yes, the absence of audited Scope 1/2/3 baselines is a material disclosure gap. If no, the claim lacks audit-trail accountability.
