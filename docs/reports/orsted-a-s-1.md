...
**[1] EU Green Claims Directive Substantiation Requirements**
The Green Claims Directive (COM/2023/0166) establishes mandatory substantiation criteria for renewable energy claims. Article 3(1) requires that claims disclose:
...
*Source: EUR-LEX, COM/2023/0166, 2023, https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:52023PC0166*
...
This is not a contradiction of the claim, but a substantiation failure under Green Claims Directive standards.
...
The claim that Ørsted has "transformed from one of Europe's most coal-intensive utilities to a global leader in renewable energy" is **directionally plausible** but **cannot be independently substantiated** against the measurable standards established by the EU Green Claims Directive and available regulatory data.

**Substantiation Failure (Primary Finding):**
Under Green Claims Directive Article 3(1), renewable energy claims must include specific, verifiable metrics. The Ørsted claim provides none:
...
This is a **Green Claims Directive compliance failure**, not necessarily evidence that the claim is false, but evidence that it cannot be verified as truthful.
...
|-----------|-------|-----------|
| **Claim Substantiation** | 35/100 | Claim lacks specific baselines, percentages, and methodological disclosure required by Green Claims Directive |
...
Ørsted's claim of transformation from coal intensity to renewable leadership cannot be independently verified because: (1) the company discloses no specific baseline coal percentage, current renewable percentage, or methodology—failing EU Green Claims Directive substantiation requirements; and (2) no EU ETS historical emissions data is available to corroborate the claimed transformation. The company's 2022 TPI assessment validates forward-looking climate credibility but does not verify the historical claim.
...
**Recommendation for Ørsted:** To substantiate this claim under Green Claims Directive standards, the company should publicly disclose: (a) coal generation capacity and emissions as a percentage of total portfolio in a defined baseline year (e.g., 2006, 2010); (b) current renewable generation percentage; (c) renewable energy sourcing methodology (owned assets, PPAs, certificates); and (d) annual historical transition metrics (2005–present).
...
2. **Why not SUBSTANTIATED?** The company provides zero quantitative baselines (no coal %, no renewable %, no time period). Green Claims Directive Article 3 explicitly requires these. A claim cannot be substantiated if the company discloses no measurable evidence.
...
- EUR-LEX substantiation gap: -20% confidence (clear non-compliance with Green Claims Directive)
