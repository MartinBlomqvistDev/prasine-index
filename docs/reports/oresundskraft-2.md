...
**[3] Green Claims Directive (COM/2023/0166)**  
Article 3(3)(a) of the Green Claims Directive requires that emissions reduction or capture claims must explicitly state: (a) baseline year, (b) scope (Scope 1/2/3, or sectoral boundary), and (c) methodology. Article 5 prohibits net-zero aggregation claims that obscure absolute emission increases. The Directive establishes a legal substantiation standard that bare quantity claims without disclosed baselines do not meet.  
Source: EUR_LEX [52023PC0166], 2023, https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:52023PC0166
